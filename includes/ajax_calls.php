...
{
 $SQL="SELECT workorder_work_end_time FROM workorder_works WHERE workorder_user_id=".(int) $_GET['param3']." AND DATE(workorder_work_start_time)='".$dba->escapeStr($_GET['param2'])."' ORDER BY workorder_work_end_time DESC LIMIT 0,1";
