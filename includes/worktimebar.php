<?php
     ...
     $workdate= $dba->escapeStr($_GET['param2']); 
      ...
      $SQL="SELECT asset_id,workorder_work_start_time, workorder_work_end_time,ROUND(TIME_TO_SEC(workorder_worktime)/60) as minutes FROM workorder_works WHERE ";
    ...
    "data": {
      "datasets": [
        ...
        echo gettext("Empty").": ";
              ...
              echo "\"data\":[".(($start_datetime->getTimestamp() - $last_end_datetime->getTimestamp())/60)."],\n";
              echo "\"fill\":false,\n";
              echo "\"backgroundColor\": \"red\",\n";
              echo "\"borderColor\": \"rgb(0,100,0)\",\n";
              echo "\"hoverBorderColor\": \"rgb(255,255,255)\",\n";
        ...
        echo substr($n,0,-7).": ";
          ...
          if ($last_end_datetime!="" && $last_end_datetime<$shift_end_datetime)
            ...
            echo "\"data\":[".(($shift_end_datetime->getTimestamp() - $last_end_datetime->getTimestamp())/60)."],\n";
            echo "\"fill\":false,\n";
            echo "\"backgroundColor\": \"red\",\n";
            echo "\"borderColor\": \"rgb(0,100,0)\",\n";
            echo "\"hoverBorderColor\": \"rgb(255,255,255)\",\n";
